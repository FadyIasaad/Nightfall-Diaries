...
Each scene narration should be short enough to fit subtitles clearly.
...
def main():
    ...
    log(logs_sheet, video_id, "GENERATE_STORY", f"Generated synced 6-scene story: {package['title']}")
